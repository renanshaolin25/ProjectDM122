...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_model_statuspedido_model__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_services_todo_service__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_model_status_model__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_model_status_model__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_detail_pedido_detail_pedido__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_add_pedido_add_pedido__ = __webpack_require__(102);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__model_statuspedido_model__ = __webpack_require__(155);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TodoService = /** @class */ (function () {
    function TodoService() {
        ...
        this.statusPedidos.push(new __WEBPACK_IMPORTED_MODULE_1__model_statuspedido_model__["a" /* StatusPedido */](new Date().toLocaleDateString(), null, "Lojas Edimil", 45.25, "Cometa 1", "priority-high"));
        this.statusPedidos.push(new __WEBPACK_IMPORTED_MODULE_1__model_statuspedido_model__["a" /* StatusPedido */](new Date().toLocaleDateString(), null, "Lojas Cem", 90.25, "Cometa 2", "priority-medium"));
        this.statusPedidos.push(new __WEBPACK_IMPORTED_MODULE_1__model_statuspedido_model__["a" /* StatusPedido */](new Date().toLocaleDateString(), null, "Casas Bahia", 135.25, "Cometa 3", "priority-low"));
    }
    ...
    TodoService.prototype.orderList = function (pedidos) {
        pedidos = pedidos.sort(function (obj1, obj2) {
    ...
    TodoService.prototype.loadStatusPedidosByFilter = function (status, transportadora, vendedor) {
        var _this = this;
        this.filterStatusPedidos = new Array();
        this.statusPedidos.forEach(function (item, index) {
            if (transportadora === "" && vendedor === "" && status !== "") {
                if (item.getStatus() == status)
                    _this.filterStatusPedidos.push(item);
            }
            else if (transportadora !== "" && vendedor === "" && status === "") {
                if (item.getTransportadora() == transportadora)
                    _this.filterStatusPedidos.push(item);
            }
            else if (transportadora === "" && vendedor !== "" && status === "") {
                ...
                if (item.getTransportadora() == transportadora && item.getVendedor() == vendedor)
                    _this.filterStatusPedidos.push(item);
            }
            else if (transportadora === "" && vendedor !== "" && status !== "") {
                if (item.getVendedor() == vendedor && item.getStatus() == status)
                    _this.filterStatusPedidos.push(item);
            }
            else if (transportadora !== "" && vendedor === "" && status !== "") {
                if (item.getTransportadora() == transportadora && item.getStatus() == status)
                    _this.filterStatusPedidos.push(item);
            }
            else if (transportadora !== "" && vendedor !== "" && status !== "") {
                if (item.getTransportadora() == transportadora && item.getVendedor() == vendedor && item.getStatus() == status)
                    _this.filterStatusPedidos.push(item);
            }
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__detail_pedido_detail_pedido__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__add_pedido_add_pedido__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_services_todo_service__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_model_status_model__ = __webpack_require__(79);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.loadStatusPedidos = function () {
    ...
    HomePage.prototype.filterStatusPedidos = function () {
        if (this.selectedStatus !== "" || this.selectedTransportadora !== "" || this.selectedVendedor !== "") {
            this.statusPedidos = this.todoService.loadStatusPedidosByFilter(__WEBPACK_IMPORTED_MODULE_5__app_model_status_model__["a" /* Status */][this.selectedStatus], this.selectedTransportadora, this.selectedVendedor);
        }
    };
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/home/renan/Desktop/Pós Dev Mobile and Clound/DM122/ProjectDM122/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>\n      O que devo fazer\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n\n  <ion-list>\n    <ion-item>\n      <ion-label>Filtrar por: </ion-label>\n      <ion-select [(ngModel)]="selectedStatus" name="selectedStatus" placeholder="Status">\n        <ion-option [value]="s" *ngFor="let s of status">\n          {{s}}\n        </ion-option>\n      </ion-select>\n      <ion-input [(ngModel)]="selectedVendedor" name="detail" type="string" placeholder="Vendedor"></ion-input>\n      <ion-input [(ngModel)]="selectedTransportadora" name="detail" type="string" placeholder="Transportadora"></ion-input>\n    </ion-item>\n    <ion-item>\n      <button ion-button icon-right (click)="filterStatusPedidos()">Filtrar<ion-icon name="funnel"></ion-icon></button>\n      <button ion-button icon-right (click)="loadStatusPedidos()" color="danger">Cancelar<ion-icon name="refresh"></ion-icon></button>\n    </ion-item>\n  </ion-list>\n\n\n  <ion-list>\n    <ion-item-sliding *ngFor="let sp of statusPedidos" [ngClass]="sp.status">\n      <ion-item>\n        <h2>{{sp.id}}</h2>\n        <p>{{sp.vendedor}}</p>\n      </ion-item>\n      <ion-item-options side="right">\n        <button ion-button (click)="goToDetailPedido(sp)" color="secondary" large><ion-icon name="create"></ion-icon></button>\n        <button ion-button (click)="deleteItem(sp)" color="danger" large><ion-icon name="trash"></ion-icon></button>\n      </ion-item-options>\n    </ion-item-sliding>\n    <ion-item></ion-item>\n  </ion-list>\n  <ion-fab right bottom>\n    <button ion-fab (click)="goToAddPedido()"><ion-icon name="add"></ion-icon></button>\n  </ion-fab>\n</ion-content>'/*ion-inline-end:"/home/renan/Desktop/Pós Dev Mobile and Clound/DM122/ProjectDM122/src/pages/home/home.html"*/
        }),
